...
const USE_MOCK_SERVER = true; // 使用Mock
...
export const REAL_DEVICE_SERVER_URL = 'http://192.168.137.1:8080';  // 真机调试地址
...
export const API_BASE_URL = REAL_DEVICE_SERVER_URL; // 真机调试 (http://192.168.137.1:8080)
// #endif
// #ifndef MP-WEIXIN-DEVICE
export const API_BASE_URL = LOCAL_SERVER_URL; // 模拟器/默认 (http://localhost:8080)
// #endif
