...
export default {
	...
	methods: {
		...
		handleWebSocketMessage(message) {
			console.log('[live-select] WS收到消息:', message);
...
.footer-section {
	...
	display: flex;
	justify-content: center;
	/* 原代码（无z-index），可能导致在微信小程序中被scroll-view遮挡而无法点击 */
	/* z-index: 未设置 */
	z-index: 100; /* 修改人: Claude Code | 修改原因: 解决微信小程序中刷新按钮无法点击的问题，确保footer-section层级高于scroll-view(z-index:10) */
}
